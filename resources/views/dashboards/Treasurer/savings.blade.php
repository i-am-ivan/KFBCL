                ...
                <nav x-data="{selected: $persist('Dashboard')}">
                    ...
                    <div>
                        ...
                        <ul class="mb-6 flex flex-col gap-1">
                            ...
                            <!-- Contributions -->
                            <li>
                                <a href="{{ route('treasurer.contributions') }}"
                                @click="selected = 'Contributions'"
                                class="menu-item group"
                                :class="selected === 'Contributions' ? 'menu-item-active' : 'menu-item-inactive'">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icons-tabler-outline icon-tabler-hand-click">
                                        <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                                    ...
                                    <span class="menu-item-text" :class="sidebarToggle ? 'xl:hidden' : ''">Contributions</span>
                                </a>
                            </li>

                            <!-- Savings -->
                            <li>
                                <a href="{{ route('treasurer.savings') }}"
                                @click="selected = 'Savings'"
                                class="menu-item group"
                                :class="selected === 'Savings' ? 'menu-item-active' : 'menu-item-inactive'">
                                    ...
                                    <span class="menu-item-text" :class="sidebarToggle ? 'xl:hidden' : ''">Savings</span>
                                </a>
                            </li>

                            <!-- Bonuses -->
                            <li>
                                <a href="{{ route('treasurer.bonuses') }}"
                                @click="selected = 'Bonuses'"
                                class="menu-item group"
                                :class="selected === 'Bonuses' ? 'menu-item-active' : 'menu-item-inactive'">
                                    ...
                                    <span class="menu-item-text" :class="sidebarToggle ? 'xl:hidden' : ''">Bonuses</span>
                                </a>
                            </li>

                            <!-- Loans -->
                            <li>
                                <a href="{{ route('treasurer.loans') }}"
                                @click="selected = 'Loans'"
                                class="menu-item group"
                                :class="selected === 'Loans' ? 'menu-item-active' : 'menu-item-inactive'">
                            ...
                            <!-- Fines & Penalties -->
                            <li>
                                <a href="{{ route('treasurer.fines') }}"
                                @click="selected = 'Fines'"
                                class="menu-item group"
                                :class="selected === 'Fines' ? 'menu-item-active' : 'menu-item-inactive'">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icons-tabler-outline icon-tabler-alert-triangle">
                                        <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                                        <path d="M12 9v4" />
