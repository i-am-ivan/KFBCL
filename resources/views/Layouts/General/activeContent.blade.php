{{-- Active Member Status Content --}}
        ...
        <!-- Top Navigation Menu -->
                <div class="border-b border-gray-200 dark:border-gray-800" x-data="memberInfo" x-init="init()">
                    <nav class="-mb-px flex space-x-2 overflow-x-auto [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-thumb]:bg-gray-200 dark:[&::-webkit-scrollbar-thumb]:bg-gray-600 dark:[&::-webkit-scrollbar-track]:bg-transparent [&::-webkit-scrollbar]:h-1.5">
                        ...
                        <button x-show="!isDeactivated" @click="activeTab = 'next-of-kin'"
                        ...
                        <button x-show="!isDeactivated" @click="activeTab = 'vehicles'"
                        ...
                        <button x-show="!isDeactivated" @click="activeTab = 'contributions'"
                        ...
                        <button x-show="!isDeactivated" @click="activeTab = 'savings'"
                        ...
                        <button x-show="!isDeactivated" @click="activeTab = 'loans'"
                        ...
                        <button x-show="!isDeactivated" @click="activeTab = 'fines'"
                ...
                <div class="pt-4 dark:border-gray-800 mb-8 gap-4 md:gap-6 p-6">
                                ...
                                <div class="hidden flex-col gap-3 sm:flex sm:flex-row sm:items-center">
                                    ...
                                    <div>
                                        <button @click="withdrawSavingsModal = true"
                                            class="hover:text-dark-900 shadow-theme-xs relative flex inline-flex h-11 items-center justify-center gap-2 rounded-lg border border-gray-300 bg-white px-4 py-3 whitespace-nowrap text-gray-700 text-sm font-medium transition-colors hover:bg-gray-100 hover:text-gray-700 sm:w-auto">
                                ...
                                <div x-data="savingsTable()" x-init="init()">
                                    <div class="custom-scrollbar overflow-x-auto">
                                        <table class="w-full">
                                            ...
                                            <template x-if="filteredSavings.length === 0">
                                                <tbody>
                                                    <tr>
                                            ...
                                            <template x-if="filteredSavings.length > 0">
                                                <tbody class="divide-x divide-y divide-gray-200 dark:divide-gray-800">
                                                    <template x-for="saving in paginatedFilteredSavings" :key="saving.transactionId">
                                                        <tr class="transition hover:bg-gray-50 dark:hover:bg-gray-900">
                                                            ...
                                                            <td class="p-4 whitespace-nowrap">
                                                                <div class="flex items-center col-span-2">
                                                                    <div class="flex items-center gap-3">
                                                                        <div>
                                                                            <p class="text-sm font-medium text-gray-700 dark:text-gray-400" x-text="saving.transactionId || 'N/A'"></p>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                            ...
                                                            <td class="p-4 whitespace-nowrap">
                                                                <div class="flex items-center col-span-2">
                                                                    <p class="text-sm font-medium text-gray-700 dark:text-gray-400">
                                                                        <span x-show="saving.transactionType === 'Paid-In'" class="text-success-600">+ KES </span>
                                                                        <span x-show="saving.transactionType === 'Paid-Out'" class="text-error-600">- KES </span>
                                                                        <span x-text="saving.transactionAmount ? Number(saving.transactionAmount).toLocaleString('en-KE', { minimumFractionDigits: 2, maximumFractionDigits: 2 }) : '0.00'"></span>
                                                                    </p>
                                                                </div>
                                                            </td>
                                                            ...
                                                            <td class="p-4 whitespace-nowrap">
                                                                <div class="flex items-center col-span-2">
                                                                    <p class="text-sm text-gray-700 dark:text-gray-400" x-text="saving.transactionDate ? new Date(saving.transactionDate).toLocaleDateString('en-GB', { day: '2-digit', month: 'short', year: 'numeric' }) : 'N/A'"></p>
                                                                </div>
                                                            </td>
                                                            ...
                                                            <td class="p-4 whitespace-nowrap">
                                                                <div class="flex items-center col-span-2">
                                                                    <p class="text-sm text-gray-700 dark:text-gray-400" x-text="saving.transactionMode || 'N/A'"></p>
                                                                </div>
                                                            </td>
                                                            ...
                                                            <td class="p-4 whitespace-nowrap">
                                                                <div class="flex items-center col-span-2">
                                                                    <p class="text-sm text-gray-700 dark:text-gray-400" x-text="saving.transactionCode || 'N/A'"></p>
                                                                </div>
                                                            </td>
                                                            ...
                                                            <td class="p-4 whitespace-nowrap">
                                                                <div class="flex items-center col-span-2">
                                                                    <span :class="saving.transactionType === 'Paid-In' ? 'bg-success-50 text-success-700 dark:bg-success-500/15 dark:text-success-500' : 'bg-warning-50 text-warning-700 dark:bg-warning-500/15 dark:text-warning-500'"
                                                                        class="rounded-full px-2 py-0.5 text-xs font-medium">
                                                                        <span x-text="saving.transactionType || 'N/A'"></span>
                                                                    </span>
                                                                </div>
                                                            </td>
                                                            ...
                                                            <td class="p-4 whitespace-nowrap">
                                                                <div class="flex items-center col-span-2">
                                                                    <span :class="saving.transactionStatus === 'Confirmed' ? 'bg-success-50 text-success-700 dark:bg-success-500/15 dark:text-success-500' :
                                                                            saving.transactionStatus === 'Pending' ? 'bg-warning-50 text-warning-700 dark:bg-warning-500/15 dark:text-warning-500' :
                                                                            saving.transactionStatus === 'Reversed' ? 'bg-info-50 text-info-700 dark:bg-info-500/15 dark:text-info-500' :
                                                                            'bg-error-50 text-error-600 dark:bg-error-500/15 dark:text-error-500'"
                                                                        class="rounded-full px-2 py-0.5 text-xs font-medium"
                                                                        x-text="saving.transactionStatus || 'N/A'"></span>
                                                                </div>
                                                            </td>
                                                            ...
                                                            <td class="p-4 whitespace-nowrap">
                                                                <div class="flex items-center col-span-2">
                                                                    <button @click="$dispatch('open-edit-savings-modal', { saving: saving })"
                                    ...
                                    <div class="border-t border-gray-200 px-5 py-4 dark:border-gray-800">
                                        <div class="flex justify-center pb-4 sm:hidden">
                                            <span class="block text-sm font-medium text-gray-500 dark:text-gray-400">
                                                Showing
                                                <span class="text-gray-800 dark:text-white/90" x-text="filteredStartEntry">1</span>
                                                to
                                                <span class="text-gray-800 dark:text-white/90" x-text="filteredEndEntry">1</span>
                                                of
                                                <span class="text-gray-800 dark:text-white/90" x-text="filteredSavings.length">1</span>
                                            </span>
                                        </div>
                                        ...
                                        <div class="flex items-center justify-between">
                                            ...
                                            <div class="flex w-full items-center justify-between gap-2 rounded-lg bg-gray-50 p-4 sm:w-auto sm:justify-normal sm:rounded-none sm:bg-transparent sm:p-0 dark:bg-gray-900 dark:sm:bg-transparent">
                                                <button class="shadow-theme-xs flex items-center gap-2 rounded-lg border border-gray-300 bg-white p-2 text-gray-700 hover:bg-gray-50 hover:text-gray-800 disabled:cursor-not-allowed disabled:opacity-50 sm:p-2.5 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-white/[0.03] dark:hover:text-gray-200"
                                                        ...
                                                        @click="goToFilteredPage(filteredPage - 1)">
                                                    <span>
                                                ...
                                                <span class="block text-sm font-medium text-gray-700 sm:hidden dark:text-gray-400">
                                                    Page <span x-text="filteredPage">1</span> of <span x-text="filteredTotalPages">1</span>
                                                </span>

                                                <ul class="hidden items-center gap-0.5 sm:flex">
                                                    <template x-for="n in filteredTotalPages" :key="n">
                                                        <li>
                                                            <a href="#" @click.prevent="goToFilteredPage(n)"
                                                            :class="filteredPage === n ? 'bg-brand-500 text-white' : 'hover:bg-brand-500 text-gray-700 dark:text-gray-400 hover:text-white dark:hover:text-white'"
                                    ...
                                    <div class="relative ">
                                        ...
                                        <div class="rounded-xl p-6 dark:border-gray-800 border" x-data="{ activeTab: 'memberLoans' }">
                                            ...
                                            <div class="pt-4 dark:border-gray-800">
                                                ...
                                                <div x-show="activeTab === 'memberLoans'">
                                                    ...
                                                    <div class="overflow-hidden rounded-xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]" x-data="loanTransactionsTable">
                                                        ...
                                                        <div class="flex flex-col justify-between gap-5 border-b border-gray-200 px-5 py-4 sm:flex-row lg:items-center dark:border-gray-800">
                                                            <div>
                                                                ...
                                                                <p class="mt-1 text-gray-500 text-theme-sm dark:text-gray-400">
                                                                    Review all bodaboda member loans here.
                                                                </p>
                                                            </div>
                                                            ...
                                                            <div class="hidden flex-col gap-3 sm:flex sm:flex-row sm:items-center">
                                                                ...
                                                                <!-- Print Button -->
                                                                <div>
                                                                    <button @click="printLoansReport()" class="hover:text-dark-900 shadow-theme-xs relative flex h-11 items-center justify-center gap-2 rounded-lg border border-gray-300 bg-white px-4 py-3 whitespace-nowrap text-gray-700 transition-colors hover:bg-gray-100 hover:text-gray-700 dark:border-gray-800 dark:bg-gray-900 dark:text-gray-400 dark:hover:bg-gray-800 dark:hover:text-white">
                                                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
                                                                            <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                                                                            <path d="M17 17h2a2 2 0 0 0 2 -2v-4a2 2 0 0 0 -2 -2h-14a2 2 0 0 0 -2 2v4a2 2 0 0 0 2 2h2"></path>
                                                                            <path d="M17 9v-4a2 2 0 0 0 -2 -2h-6a2 2 0 0 0 -2 2v4"></path>
                                                        ...
                                                        <div x-init="init()">
                                                            <div class="custom-scrollbar overflow-x-auto">
                                                                ...
                                                                <table class="w-full">
                                                                            ...
                                                                            <tr>
                                                                                <td colspan="10" class="px-4 py-12 text-center">
                                                                                    <div class="inline-flex flex-col items-center justify-center space-y-4 p-4">
                                                                                        ...
                                                                                        <div class="space-y-2">
                                                                                            <h2 class="text-xl font-semibold text-gray-700">Loading member loan transactions...</h2>
                                                                    ...
                                                                    <!-- Message if no transactions data found -->
                                                                    <template x-if="!isLoading && transactions.length === 0">
                                                                        <tbody>
                                                                            <tr>
                                                                                <td colspan="10" class="px-4 py-12 text-center">
                                                                                    <div class="inline-flex flex-col items-center justify-center space-y-4 p-4">
                                                                                        ...
                                                                                        <div class="space-y-2">
                                                                                            <h2 class="text-xl font-semibold text-gray-700">No loan records found</h2>
                                                                                            <p class="text-gray-500">Do some transactions to view loan performance</p>
                                                                                        </div>
                                                                                    </div>
                                                                                </td>
                                                                            </tr>
                                                                    ...
                                                                    <!-- Message if no filtered results -->
                                                                    <template x-if="!isLoading && transactions.length > 0 && filteredTransactions.length === 0">
                                                                        <tbody>
                                                                            <tr>
                                                                                <td colspan="10" class="px-4 py-12 text-center">
                                                                                    <div class="inline-flex flex-col items-center justify-center space-y-4 p-4">
                                                                    ...
                                                                    <!-- If there is data display the table -->
                                                                    <template x-if="!isLoading && filteredTransactions.length > 0">
                                                                        <tbody class="divide-x divide-y divide-gray-200 dark:divide-gray-800">
                                                            ...
                                                            <!-- Table Navigations -->
                                                            <div class="border-t border-gray-200 px-5 py-4 dark:border-gray-800" x-show="filteredTransactions.length > 0">
                                                                <div class="flex justify-center pb-4 sm:hidden">
                                                                    <span class="block text-sm font-medium text-gray-500 dark:text-gray-400">
                                                                        Showing
                                                                        ...
                                                                        of
                                                                        <span class="text-gray-800 dark:text-white/90" x-text="filteredTransactions.length"></span>
                                                                    </span>
                                                                </div>
                                                                ...
                                                                <div class="flex items-center justify-between">
                                                                    ...
                                                                    <div class="flex w-full items-center justify-between gap-2 rounded-lg bg-gray-50 p-4 sm:w-auto sm:justify-normal sm:rounded-none sm:bg-transparent sm:p-0 dark:bg-gray-900 dark:sm:bg-transparent">
                                                                        <button class="shadow-theme-xs flex items-center gap-2 rounded-lg border border-gray-300 bg-white p-2 text-gray-700 hover:bg-gray-50 hover:text-gray-800 disabled:cursor-not-allowed disabled:opacity-50 sm:p-2.5 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-white/[0.03] dark:hover:text-gray-200" :disabled="page === 1" @click="prevPage()">
                                                                            <span>
                                                                                <svg class="fill-current" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M2.58203 9.99868C2.58174 10.1909 2.6549 10.3833 2.80152 10.53L7.79818 15.5301C8.09097 15.8231 8.56584 15.8233 8.85883 15.5305C9.15183 15.2377 9.152 14.7629 8.85921 14.4699L5.13911 10.7472L16.6665 10.7472C17.0807 10.7472 17.4165 10.4114 17.4165 9.99715C17.4165 9.58294 17.0807 9.24715 16.6665 9.24715L5.14456 9.24715L8.85919 5.53016C9.15199 5.23717 9.15184 4.7623 8.85885 4.4695C8.56587 4.1767 8.09099 4.17685 7.79819 4.46984L2.84069 9.43049C2.68224 9.568 2.58203 9.77087 2.58203 9.99715C2.58203 9.99766 2.58203 9.99817 2.58203 9.99868Z" fill=""></path>
                                                                                </svg>
                                                                        ...
                                                                        <button class="shadow-theme-xs flex items-center gap-2 rounded-lg border border-gray-300 bg-white p-2 text-gray-700 hover:bg-gray-50 hover:text-gray-800 disabled:cursor-not-allowed disabled:opacity-50 sm:p-2.5 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-white/[0.03] dark:hover:text-gray-200" :disabled="page === totalPages" @click="nextPage()">
                                                                            <span>
                                                                                <svg class="fill-current" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M17.4165 9.9986C17.4168 10.1909 17.3437 10.3832 17.197 10.53L12.2004 15.5301C11.9076 15.8231 11.4327 15.8233 11.1397 15.5305C10.8467 15.2377 10.8465 14.7629 11.1393 14.4699L14.8594 10.7472L3.33203 10.7472C2.91782 10.7472 2.58203 10.4114 2.58203 9.99715C2.58203 9.58294 2.91782 9.24715 3.33203 9.24715L14.854 9.24715L11.1393 5.53016C10.8465 5.23717 10.8467 4.7623 11.1397 4.4695C11.4327 4.1767 11.9075 4.17685 12.2003 4.46984L17.1578 9.43049C17.3163 9.568 17.4165 9.77087 17.4165 9.99715C17.4165 9.99763 17.4165 9.99812 17.4165 9.9986Z" fill=""></path>
                                                                                </svg>
                    ...
                    <div x-show="activeTab === 'fines'">
                                    <div class="overflow-hidden rounded-xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]" x-data="bonusFineTable" x-init="init()">
                                        <!-- Contributions content here -->
                                        <div class="flex flex-col justify-between gap-5 border-b border-gray-200 px-5 py-4 sm:flex-row lg:items-center dark:border-gray-800" >
                                            <div>
                                                <h3 class="text-lg font-semibold text-gray-800 dark:text-white/90">
                                            ...
                                            <div class="custom-scrollbar overflow-x-auto">
                                                <table class="w-full table-auto">
                                                    ...
                                                    <tbody>
                                                            ...
                                                            <tr>
                                                                <td colspan="8" class="px-4 py-12 text-center">
                                                                    <div class="inline-flex flex-col items-center justify-center space-y-4 p-4">
                                                                        ...
                                                                        <div class="space-y-2">
                                                                            <h2 class="text-xl font-semibold text-gray-700">Loading member transaction data ...</h2>
                                                                            <p class="text-gray-500">Please wait while we fetch the records.</p>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                        ...
                                                        <!-- NO TRANSACTIONS AT ALL (empty database) -->
                                                        <template x-if="!isLoading && transactions.length === 0">
                                                            <tr>
                                                                <td colspan="8" class="px-4 py-12 text-center">
                                                                    <div class="inline-flex flex-col items-center justify-center space-y-4 p-4">
                                                                        ...
                                                                        <div class="space-y-2">
                                                                            ...
                                                                            <p class="text-gray-500">Award a bonus or assign a fine to get started.</p>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                        ...
                                                        <!-- DATA ROWS -->
                                                        <template x-if="!isLoading && filteredTransactions.length > 0">
                                                            <template x-for="tx in paginatedTransactions" :key="tx.transactionID">
                                                                <tr class="transition hover:bg-gray-50 dark:hover:bg-gray-900">
                                                                    <!-- Transaction ID -->
                                                                    <td class="p-4 whitespace-nowrap">
                                                                        <span class="text-theme-xs font-medium text-gray-700 dark:text-gray-400" x-text="tx.transactionID"></span>
                                                                    </td>

                                                                    <!-- Type (Bonus/Fine name) -->
                                                                    <td class="p-4 whitespace-nowrap">
                                                                        <div>
                                                                            <span class="text-sm font-medium text-gray-700 dark:text-gray-400" x-text="tx.type_name"></span>
                                                                            <p class="text-xs text-gray-500 dark:text-gray-400" x-text="'(' + tx.type_category + ')'"></p>
                                                                        </div>
                                                                    </td>

                                                                    <!-- Transaction Code -->
                                                                    <td class="p-4 whitespace-nowrap">
                                                                        <span class="text-sm text-gray-700 dark:text-gray-400" x-text="tx.transactionCode || '—'"></span>
                                                                    </td>

                                                                    <!-- Amount -->
                                                                    <td class="p-4 whitespace-nowrap">
                                                                        <span class="text-sm font-medium text-gray-700 dark:text-gray-400" x-text="formatCurrency(tx.transactionAmount)"></span>
                                                                    </td>

                                                                    <!-- Date (formatted: 08 Apr 2026, 04:55 PM) -->
                                                                    <td class="p-4 whitespace-nowrap">
                                                                        <p class="text-sm text-gray-700 dark:text-gray-400 truncate max-w-[200px]"
                                                                        x-text="formatDate(tx.transactionDate)"
                                                                        :title="formatDate(tx.transactionDate)"></p>
                                                                    </td>

                                                                    <!-- Payment Mode -->
                                                                    <td class="p-4 whitespace-nowrap">
                                                                        <span class="text-sm text-gray-700 dark:text-gray-400" x-text="tx.transactionMode"></span>
                                                                    </td>

                                                                    <!-- Status -->
                                                                    <td class="p-4 whitespace-nowrap">
                                                                        <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium"
                                                                            :class="getStatusClass(tx.transactionStatus)"
                                                                            x-text="tx.transactionStatus">
                                                                        </span>
                                                                    </td>
